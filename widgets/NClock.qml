...
Item {
    ...
    property color clockColor: NColors.mOnPrimary
    property color secondHandColor: NColors.mError
    property color progressColor: root.secondHandColor

    property real hoursFontSize: NStyle.fontSizeXL
    property real minutesFontSize: NStyle.fontSizeM

    // Size calculation (Adapted to NStyle)
    height: NStyle.baseWidgetSize * 3
    width: height
        ...
        Item {
            ...
            Canvas {
                ...
                onPaint: {
                    ...
                    ctx.lineWidth = 2 * NStyle.uiScaleRatio;
                    ...
                    ctx.lineWidth = 3 * NStyle.uiScaleRatio;
                    ctx.lineCap = "round";
                    ctx.beginPath();
                    ctx.moveTo(0, 0);
                    ...
                    ctx.lineWidth = 1.5 * NStyle.uiScaleRatio;
                    ctx.lineCap = "round";
                    ctx.beginPath();
                    ctx.moveTo(0, 0);
                    ctx.lineTo(0, -radius);
                    ...
                    // Center Dot
                    ctx.beginPath();
                    ctx.arc(0, 0, 3 * NStyle.uiScaleRatio, 0, 2 * Math.PI);
        ...
        Item {
            ...
            ColumnLayout {
                ...
                NText {
                    ...
                    font.weight: NStyle.fontWeightBold
